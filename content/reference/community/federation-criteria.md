...
1. Clearly defined [collection metadata]({{< relref "/reference/collection/metadata" >}}).
...
For detailed instructions on joining the federation, refer to the How to Join the Federation guide.
