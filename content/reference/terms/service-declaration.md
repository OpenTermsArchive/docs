...
{{< refItem
    ...
    description="Array of filter function names to apply. Function will be executed in the order of the array. See the [Filters]({{< relref \"reference/terms/filters\" >}}) section for more information."
